...
function App() {
  // const [mpHands, setMpHanhs] = useState<any>(window)
  // const [drawingUtils, setdrawingUtils] = useState<any>(window)
  // const [controls, setcontrols] = useState<any>(window)
  // const [controls3d, setcontrols3d] = useState<any>(window)
  ...
  //       colors.push({
  //         list: offsetConnections.map((unused: any, i: any) => i + offset),
  ...
  return (
    ...
    <a className="abs logo" href="http://www.mediapipe.dev" target="_blank">
      <div className='styleImg' >
        <img className="logo" src="logo_white.png" alt=""/>
